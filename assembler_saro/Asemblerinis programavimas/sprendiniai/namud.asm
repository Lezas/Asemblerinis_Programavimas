...
duom segment         
	;pranesimai
	pran1 db 'Namu darbas',10,13,'$'
	pran2 DB 'Uzduoti atliko: Arturas Janulis II/081',13,10,'$'
	pran3 DB 'Salyga: Apskaiciuoja dvizenkliu skaiciu suma',10,13,'$'
	pran4 db 10,13,'Skaiciu suma: $'                       
	pran6 db 'Iveskite pirmaji dvizenkli ir spauskite ENTER: $'
	pran7 db 10,13,'Iveskite antraji dvizenkli ir paspauskite ENTER: $'                 
	pran8 db 10,13,'Didesnio neidvizenklio negalima vesti!!!! $'
