...
duomenys segment                               
       vardas  db 10,13,10,13,'Atliko: II-2/2, Sarunas Jankauskas','$'
       kursin  db 10,13,'Asemblerinio programavimo kursinis darbas','$'
       uzd     db 10,13,10,13,10,13,'Uzduotis Nr.2',10,13,'Programa papraso vartotojo ivesti simboliu eilute ir isveda nauja eilute, kuri sudaryta is ivestos eilutes mazasias raides pakeitus didziosiomis, o didziasias mazosiomis (kiti simboliai lieka nepakite).',10,13,'$'        
...
mov bx,0                
mov stulp,0         ;bus reikalinga rez spausdinimui stulpelems didint
;mov ax, 0002h       ;valau ekrana                      
;int 10h 
jmp rezult                                                               
